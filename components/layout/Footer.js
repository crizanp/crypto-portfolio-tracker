        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Track your crypto portfolio with ease. Monitor performance, set targets, and analyze your investments.
            </p>
          </div>
            ...
            <div className="mt-4">
              ...
              <div className="flex">
                <input
                  ...
                  className="bg-gray-700 text-white px-3 py-2 rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500 w-full"
                />
